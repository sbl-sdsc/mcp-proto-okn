...
DOMAIN_TAGS = {'biobricks-aopwiki': ['biology', 'health', 'toxicology'],
 ...
 'nestkg': ['biology', 'biomedical', 'cancer', 'genomics', 'pathways'],
...
IDENTIFIER_NAMESPACES = {'biobricks-aopwiki': ['CAS', 'ChEBI', 'ChEMBL', 'InChIKey', 'PubChem'],
 ...
 'biomarkerkg': ['DOID',
                 ...
                 'UBERON',
                 'UniProt'],
 'climatemodelskg': ['DOI', 'GCMD', 'GeoNames', 'OpenAlex'],
 ...
 'medical-device-kg': ['CFR_Title_21',
                       'FDA_510k',
                       'FDA_De_Novo',
                       'FDA_FEI',
                       'FDA_HDE',
 ...
 'ncipidkg': ['CAS', 'ChEBI', 'GO', 'INDRA', 'NCI-PID', 'RO', 'UniProt'],
 'nde': ['PubMed'],
 'nestkg': ['DOI', 'ECO', 'MONDO', 'NDEx', 'NeST', 'UniProt'],
 'nikg': ['FIPS'],
 ...
 'ruralkg': ['FIPS', 'GNIS', 'RUCC', 'Wikidata'],
 'sawgraph': ['CAS', 'DTXSID', 'FOODON', 'NCBI_Taxon', 'PWSID', 'S2Cell'],
 'scales': [],
...
EXAMPLE_QUERIES = {'biobricks-aopwiki': ['What adverse outcome pathways involve estrogen receptor activation?'],
 ...
 'climatemodelskg': ['What climate models cover a specific region?',
                     'Which natural hazards or weather events affected a given country?',
                     'Which papers cite a given paper, and what methods do they apply?'],
 ...
 'medical-device-kg': ['What event types are reported for a specific medical device?',
                       'Which devices with a given FDA product code have been recalled, and why?',
                       'What are the most reported device problems and patient outcomes for a product code?',
                       'Which 510(k) clearances or PMA approvals did a manufacturer receive, and when?'],
 ...
 'ncipidkg': ['What proteins directly regulate EGFR, and how much evidence supports each edge?',
              'Which molecular interactions have evidence counts and evidence URLs?',
              'Which directly-regulates relationships are annotated with a Gene Ontology '
              'process or post-translational-modification type?'],
 'nestkg': ['Which NeST protein systems are recurrently mutated in a given cancer type?',
            'What proteins are members of a named protein system, and what systems is it nested in?',
            'Which protein-protein interactions support a system, and what are their IAS scores?'],
 ...
 'ruralkg': ['What substance abuse treatment providers are in rural counties?',
             ...
             'Which NSDUH survey variables mention a given substance, and what is its Wikidata ID?'],
 'sawgraph': ['Where have PFAS been detected in drinking water?',
              'What food products contain contaminants?',
              'Which organization reported a contaminant measurement, and what detection limit applied?'],
