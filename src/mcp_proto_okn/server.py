...
class SPARQLServer:
    ...
    def execute(self, query_string: str) -> Dict[str, Any]:
        """Execute an arbitrary SPARQL query and return the JSON result or an error dict."""
        try:
...
LIMIT 200
        ...
        return {
            "classes": self._extract_values(classes, "class"),
            "predicates": self._extract_values(predicates, "predicate"),
        }
...
"""
    ...
    def get_schema() -> Union[Dict[str, Any], List[Dict[str, Any]]]:
        return sparql_server.query_schema()
